namespace MovieRental.MovieForms
{
    public class AddMovieForm : MovieForm
    {
        ...
        protected override void SaveButton_Click(object sender, EventArgs e)
        {
            ...
            string query = @"INSERT INTO [Movie Tape] (Title, Description, ActorId, GenreId, RentalCharge, ReleaseDate, ImagePath, IsAvailable) VALUES (@title, @description, @actorId, @genreId, @price, @releaseDate, @imagePath, @isAvailable)";
