...
CREATE TABLE Rents (
  [UID] INT,
  TapeID INT,
  RentDate DATE DEFAULT CAST(GETDATE() AS DATE),
  ReturnDate AS DATEADD(MONTH, 1, RentDate) PERSISTED,
