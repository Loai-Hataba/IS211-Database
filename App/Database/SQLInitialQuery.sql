...
INSERT INTO [MovieTape] ([Title], [Description], [ActorID], [GenreID], [RentalCharge], [ReleaseDate], [ImagePath], [IsAvailable])
VALUES 
...
CREATE TABLE Rents (
  ...
  FOREIGN KEY (UID) REFERENCES Customer (UID),
  FOREIGN KEY (TapeID) REFERENCES MovieTape(TapeID)
);
